...
const useStore = create((set) => ({
  ...
  switchMainView: (type) => set({
    ...
    resources: []
    // Clear resources when switching views
  }),
...
function Sidebar({ className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("w-64 bg-slate-900 text-white flex flex-col border-r border-slate-700", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-slate-700 font-bold text-lg flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 bg-blue-500 rounded-lg" }),
      "Gins Proton"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 p-2 space-y-1", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => switchMainView(item.type),
        className: cn(
          "w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors",
          currentResourceType === item.type ? "bg-blue-600 text-white" : "text-slate-400 hover:bg-slate-800 hover:text-white"
        ),
        children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-t border-slate-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Region: us-east-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Profile: default" })
    ] })
  ] });
}
function MainLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col h-full overflow-hidden", children })
  ] });
}
function MasterDetailView({ top, bottom, className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex flex-col h-full w-full", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2/5 border-b border-slate-200 dark:border-slate-800 overflow-auto bg-white dark:bg-slate-900", children: top }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden bg-slate-50 dark:bg-slate-950", children: bottom })
  ] });
}
function ResourceTable() {
  ...
  const handleDoubleClick = (item) => {
    const id2 = item.Name;
    if (!id2) return;
    console.log("Deep dive into", id2);
    useStore.getState().pushBreadcrumb({ type: useStore.getState().currentResourceType, id: id2 });
  ...
  if (resources.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center text-slate-500", children: "No resources found." });
  }
  const sample = resources[0];
  const columns = Object.keys(sample).filter((k2) => typeof sample[k2] !== "object" && k2 !== "DefaultRunProperties");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-slate-100 dark:bg-slate-800 text-xs uppercase text-slate-500 sticky top-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 font-medium cursor-pointer hover:text-slate-700", children: col }, col)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-slate-200 dark:divide-slate-800", children: resources.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "tr",
      {
        ...
        className: `
              ...
              `,
        children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 truncate max-w-[200px]", children: renderCell(item[col]) }, col))
      },
      idx
    )) })
  ] }) });
  ...
  !function(e, t2) {
    ...
    return function(e2) {
      ...
      return n2.m = e2, n2.c = t2, n2.d = function(e3, t3, a) {
        ...
        if (n2.r(a), Object.defineProperty(a, "default", { enumerable: true, value: e3 }), 2 & t3 && "string" != typeof e3) for (var r2 in e3) n2.d(a, r2, function(t4) {
          return e3[t4];
        }.bind(null, r2));
        return a;
      }, n2.n = function(e3) {
      ...
      t2.f = n2(4) ? Object.defineProperty : function(e3, t3, n3) {
        if (a(e3), t3 = o(t3, true), a(n3), r2) try {
          return i(e3, t3, n3);
        } catch (e4) {
        }
      ...
      var a = n2(3), r2 = n2(1), o = n2(53), i = n2(6), s = n2(5), c = function(e3, t3, n3) {
        ...
        for (l2 in d && (n3 = t3), n3) (u2 = !p2 && E2 && void 0 !== E2[l2]) && s(y2, l2) || (f2 = u2 ? E2[l2] : n3[l2], y2[l2] = d && "function" != typeof E2[l2] ? n3[l2] : v2 && u2 ? o(f2, a) : m2 && E2[l2] == f2 ? function(e4) {
      ...
      e2.exports = function(e3, t3) {
        if (!a(e3)) return e3;
        var n3, r2;
        if (t3 && "function" == typeof (n3 = e3.toString) && !a(r2 = n3.call(e3))) return r2;
        if ("function" == typeof (n3 = e3.valueOf) && !a(r2 = n3.call(e3))) return r2;
        if (!t3 && "function" == typeof (n3 = e3.toString) && !a(r2 = n3.call(e3))) return r2;
      ...
      e2.exports = function(e3, t3, n3, b, h, v2, m2) {
        ...
        if (A2 && (E2 = u2(A2.call(new e3()))) !== Object.prototype && E2.next && (l2(E2, x2, true), a || "function" == typeof E2[f2] || i(E2, f2, d)), _ && C2 && "values" !== C2.name && (k2 = true, S2 = function() {
          return C2.call(this);
        }), a && !m2 || !p2 && !k2 && O2[f2] || i(O2, f2, S2), s[t3] = S2, s[x2] = d, h) if (y2 = { values: _ ? S2 : j("values"), keys: v2 ? S2 : j("keys"), entries: w2 }, m2) for (g in y2) g in O2 || o(O2, g, y2[g]);
        else r2(r2.P + r2.F * (p2 || k2), t3, y2);
        return y2;
      };
    }, function(e2, t2, n2) {
      ...
      var a = n2(10), r2 = n2(56), o = n2(27), i = n2(25)("IE_PROTO"), s = function() {
        ...
        for (t3.style.display = "none", n2(60).appendChild(t3), t3.src = "javascript:", (e3 = t3.contentWindow.document).open(), e3.write("<script>document.F=Object<\/script>"), e3.close(), c = e3.F; a2--; ) delete c.prototype[o[a2]];
        return c();
      };
      ...
      e2.exports = function(e3, t3) {
        ...
        for (n3 in s) n3 != i && a(s, n3) && l2.push(n3);
        for (; t3.length > c; ) a(s, n3 = t3[c++]) && (~o(l2, n3) || l2.push(n3));
        return l2;
      };
    }, function(e2, t2, n2) {
      var a = n2(24);
      ...
      var a = n2(24), r2 = n2(2)("toStringTag"), o = "Arguments" == a(/* @__PURE__ */ function() {
        return arguments;
      }());
      e2.exports = function(e3) {
        var t3, n3, i;
      ...
      var a = d(n2(49)), r2 = d(n2(76)), o = d(n2(81)), i = d(n2(89)), s = d(n2(93)), c = function(e3) {
        ...
        var t3 = {};
        if (null != e3) for (var n3 in e3) Object.prototype.hasOwnProperty.call(e3, n3) && (t3[n3] = e3[n3]);
      ...
      var b = c.default, h = (0, i.default)(b), v2 = (0, f2.default)(u2.default, p2.rgb2yuv, function(e3) {
        ...
        for (var o2 in e3) -1 === n3.indexOf(o2) && n3.push(o2);
        return n3.reduce(function(n4, o3) {
          return n4[o3] = function(e4, t4) {
            if (void 0 === e4) return t4;
        ...
        for (var n3 = arguments.length, o2 = Array(n3 > 2 ? n3 - 2 : 0), s2 = 2; s2 < n3; s2++) o2[s2 - 2] = arguments[s2];
        ...
        for (var t3 = arguments.length, n3 = Array(t3 > 3 ? t3 - 3 : 0), a2 = 3; a2 < t3; a2++) n3[a2 - 3] = arguments[a2];
      ...
      function f2(e3, t3, n3, a2) {
        var r3, o2, i2, s2;
        if (l2(n3), void 0 === (o2 = e3._events) ? (o2 = e3._events = /* @__PURE__ */ Object.create(null), e3._eventsCount = 0) : (void 0 !== o2.newListener && (e3.emit("newListener", t3, n3.listener ? n3.listener : n3), o2 = e3._events), i2 = o2[t3]), void 0 === i2) i2 = o2[t3] = n3, ++e3._eventsCount;
      ...
      function v2(e3, t3) {
        for (var n3 = new Array(t3), a2 = 0; a2 < t3; ++a2) n3[a2] = e3[a2];
        return n3;
      }
      Object.defineProperty(s, "defaultMaxListeners", { enumerable: true, get: function() {
        ...
        if ("function" == typeof c2) o(c2, this, t3);
        else {
          var l3 = c2.length, u3 = v2(c2, l3);
          for (n3 = 0; n3 < l3; ++n3) o(u3[n3], this, t3);
        }
        return true;
        ...
        var n3, a2, r3, o2, i2;
        if (l2(t3), void 0 === (a2 = this._events)) return this;
        if (void 0 === (n3 = a2[e3])) return this;
        if (n3 === t3 || n3.listener === t3) 0 == --this._eventsCount ? this._events = /* @__PURE__ */ Object.create(null) : (delete a2[e3], a2.removeListener && this.emit("removeListener", e3, n3.listener || t3));
        else if ("function" != typeof n3) {
          for (r3 = -1, o2 = n3.length - 1; o2 >= 0; o2--) if (n3[o2] === t3 || n3[o2].listener === t3) {
        ...
        else if (void 0 !== t3) for (a2 = t3.length - 1; a2 >= 0; a2--) this.removeListener(e3, t3[a2]);
        return this;
      ...
      e2.exports = n2(4) ? Object.defineProperties : function(e3, t3) {
        r2(e3);
        for (var n3, i = o(t3), s = i.length, c = 0; s > c; ) a.f(e3, n3 = i[c++], t3[n3]);
        return e3;
      };
    }, function(e2, t2, n2) {
      ...
      e2.exports = function(e3) {
        return function(t3, n3, i) {
          ...
          if (e3 && n3 != n3) {
            for (; l2 > u2; ) if ((s = c[u2++]) != s) return true;
          } else for (; l2 > u2; u2++) if ((e3 || u2 in c) && c[u2] === n3) return e3 || u2 || 0;
          return !e3 && -1;
        };
      };
    }, function(e2, t2, n2) {
      ...
      var a = n2(3), r2 = n2(5), o = n2(4), i = n2(15), s = n2(37), c = n2(68).KEY, l2 = n2(8), u2 = n2(26), f2 = n2(28), p2 = n2(17), d = n2(2), b = n2(30), h = n2(31), v2 = n2(69), m2 = n2(70), y2 = n2(10), g = n2(11), E2 = n2(18), j = n2(9), x2 = n2(23), _ = n2(16), k2 = n2(38), O2 = n2(71), C2 = n2(72), S2 = n2(32), w2 = n2(7), A2 = n2(13), M2 = C2.f, P2 = w2.f, F2 = O2.f, D2 = a.Symbol, I2 = a.JSON, R2 = I2 && I2.stringify, L2 = d("_hidden"), B2 = d("toPrimitive"), N2 = {}.propertyIsEnumerable, z2 = u2("symbol-registry"), T2 = u2("symbols"), q2 = u2("op-symbols"), V2 = Object.prototype, K2 = "function" == typeof D2 && !!S2.f, W2 = a.QObject, H2 = !W2 || !W2.prototype || !W2.prototype.findChild, U2 = o && l2(function() {
        ...
        y2(e3);
        for (var n3, a2 = v2(t3 = j(t3)), r3 = 0, o2 = a2.length; o2 > r3; ) Y2(e3, n3 = a2[r3++], t3[n3]);
        return e3;
      }, Q2 = function(e3) {
        ...
        for (var t3, n3 = F2(j(e3)), a2 = [], o2 = 0; n3.length > o2; ) r2(T2, t3 = n3[o2++]) || t3 == L2 || t3 == c || a2.push(t3);
        return a2;
      }, ee2 = function(e3) {
        for (var t3, n3 = e3 === V2, a2 = F2(n3 ? q2 : j(e3)), o2 = [], i2 = 0; a2.length > i2; ) !r2(T2, t3 = a2[i2++]) || n3 && !r2(V2, t3) || o2.push(T2[t3]);
        return o2;
      };
      K2 || (s((D2 = function() {
      ...
      for (var te2 = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), ne2 = 0; te2.length > ne2; ) d(te2[ne2++]);
      for (var ae2 = A2(d.store), re2 = 0; ae2.length > re2; ) h(ae2[re2++]);
      i(i.S + i.F * !K2, "Symbol", { for: function(e3) {
        return r2(z2, e3 += "") ? z2[e3] : z2[e3] = D2(e3);
      }, keyFor: function(e3) {
        if (!J2(e3)) throw TypeError(e3 + " is not a symbol!");
        for (var t3 in z2) if (z2[t3] === e3) return t3;
      }, useSetter: function() {
        H2 = true;
      }, useSimple: function() {
        H2 = false;
      ...
      i(i.S + i.F * oe2, "Object", { getOwnPropertySymbols: function(e3) {
        ...
        for (var t3, n3, a2 = [e3], r3 = 1; arguments.length > r3; ) a2.push(arguments[r3++]);
        if (n3 = t3 = a2[1], (g(t3) || void 0 !== e3) && !J2(e3)) return m2(t3) || (t3 = function(e4, t4) {
          if ("function" == typeof n3 && (t4 = n3.call(this, e4, t4)), !J2(t4)) return t4;
      ...
      e2.exports = function(e3) {
        var t3 = a(e3), n3 = r2.f;
        if (n3) for (var i, s = n3(e3), c = o.f, l2 = 0; s.length > l2; ) c.call(e3, i = s[l2++]) && t3.push(i);
        return t3;
      };
    }, function(e2, t2, n2) {
      var a = n2(24);
      ...
      t2.f = n2(4) ? l2 : function(e3, t3) {
        if (e3 = o(e3), t3 = i(t3, true), c) try {
          return l2(e3, t3);
        } catch (e4) {
        }
        if (s(e3, t3)) return r2(!a.f.call(e3, t3), e3[t3]);
      };
    }, function(e2, t2) {
    }, function(e2, t2, n2) {
      n2(31)("asyncIterator");
      ...
      e2.exports = !l2 || n2(8)(function() {
        ...
        for (var n3 = s(e3), l3 = arguments.length, u2 = 1, f2 = o.f, p2 = i.f; l3 > u2; ) for (var d, b = c(arguments[u2++]), h = f2 ? r2(b).concat(f2(b)) : r2(b), v2 = h.length, m2 = 0; v2 > m2; ) d = h[m2++], a && !p2.call(b, d) || (n3[d] = b[d]);
        return n3;
      } : l2;
    }, function(e2, t2, n2) {
      t2.__esModule = true;
      ...
      t2.default = function(e3, t3) {
        ...
        if ((0, a.default)(Object(e3))) return function(e4, t4) {
      ...
      e2.exports = n2(1).getIterator = function(e3) {
        var t3 = r2(e3);
        if ("function" != typeof t3) throw TypeError(e3 + " is not iterable!");
        return a(t3.call(e3));
      };
    }, function(e2, t2, n2) {
      var a = n2(42), r2 = n2(2)("iterator"), o = n2(12);
      ...
      (function(t3) {
        ...
        function m2(e3, t4) {
          return !!(e3 ? e3.length : 0) && function(e4, t5, n4) {
            if (t5 != t5) return function(e5, t6, n5, a3) {
              var r4 = e5.length, o2 = n5 + -1;
              for (; ++o2 < r4; ) if (t6(e5[o2], o2, e5)) return o2;
              return -1;
            }(e4, y2, n4);
            var a2 = n4 - 1, r3 = e4.length;
            for (; ++a2 < r3; ) if (e4[a2] === t5) return a2;
            return -1;
          }(e3, t4, 0) > -1;
        }
        function y2(e3) {
        ...
        function g(e3, t4) {
          for (var n4 = e3.length, a2 = 0; n4--; ) e3[n4] === t4 && a2++;
          return a2;
        }
        function E2(e3, t4) {
        ...
        function N2(e3, t4, n4, a2) {
          for (var r3 = -1, o2 = e3.length, i2 = n4.length, s2 = -1, c2 = t4.length, l3 = D2(o2 - i2, 0), u3 = Array(c2 + l3), f3 = !a2; ++s2 < c2; ) u3[s2] = t4[s2];
          for (; ++r3 < i2; ) (f3 || r3 < o2) && (u3[n4[r3]] = e3[r3]);
          for (; l3--; ) u3[s2++] = e3[r3++];
          return u3;
        }
        function z2(e3, t4, n4, a2) {
          for (var r3 = -1, o2 = e3.length, i2 = -1, s2 = n4.length, c2 = -1, l3 = t4.length, u3 = D2(o2 - s2, 0), f3 = Array(u3 + l3), p3 = !a2; ++r3 < u3; ) f3[r3] = e3[r3];
          for (var d2 = r3; ++c2 < l3; ) f3[d2 + c2] = t4[c2];
          for (; ++i2 < s2; ) (p3 || r3 < o2) && (f3[d2 + n4[i2]] = e3[r3++]);
          return f3;
        }
        function T2(e3) {
          return function() {
        ...
        function K2(e3, t4, n4, a2, r3, o2, i2, s2) {
          ...
          if (e3 = p3[0], t4 = p3[1], n4 = p3[2], a2 = p3[3], r3 = p3[4], !(s2 = p3[9] = null == p3[9] ? c2 ? 0 : e3.length : D2(p3[9] - l3, 0)) && 24 & t4 && (t4 &= -25), t4 && 1 != t4) d2 = 8 == t4 || 16 == t4 ? function(e4, t5, n5) {
            var a3 = T2(e4);
            return function r4() {
              for (var o3 = arguments.length, i3 = Array(o3), s3 = o3, c3 = W2(r4); s3--; ) i3[s3] = arguments[s3];
              var l4 = o3 < 3 && i3[0] !== c3 && i3[o3 - 1] !== c3 ? [] : E2(i3, c3);
              if ((o3 -= l4.length) < n5) return V2(e4, t5, q2, r4.placeholder, void 0, i3, l4, void 0, void 0, n5 - o3);
            ...
            return function t6() {
              for (var i3 = -1, s3 = arguments.length, c3 = -1, l4 = a3.length, u4 = Array(l4 + s3), f4 = this && this !== h && this instanceof t6 ? o3 : e4; ++c3 < l4; ) u4[c3] = a3[c3];
              for (; s3--; ) u4[c3++] = arguments[++i3];
              return v2(f4, r4 ? n5 : this, u4);
            };
          }(e3, t4, n4, a2);
          else var d2 = function(e4, t5, n5) {
        ...
        function Y2(e3, t4) {
          for (var n4 = e3.length, a2 = I2(t4.length, n4), r3 = function(e4, t5) {
            ...
            for (t5 || (t5 = Array(a3)); ++n5 < a3; ) t5[n5] = e4[n5];
            return t5;
          }(e3); a2--; ) {
            var o2 = t4[a2];
      ...
      function c(e3) {
        for (var t3 in s) if (0 === e3.indexOf(t3)) return s[t3](e3);
      }
      ...
      e2.exports = function(e3) {
        ...
        for (var l2 = 0; l2 < 3; l2++) (a = i + 1 / 3 * -(l2 - 1)) < 0 && a++, a > 1 && a--, o = 6 * a < 1 ? t3 + 6 * (n2 - t3) * a : 2 * a < 1 ? n2 : 3 * a < 2 ? t3 + (n2 - t3) * (2 / 3 - a) * 6 : t3, r2[l2] = 255 * o;
        return r2;
      };
    }, function(e2, t2, n2) {
      (function(t3) {
        ...
        function i(e3, t4) {
          for (var n4 = -1, a2 = t4.length, r3 = e3.length; ++n4 < a2; ) e3[r3 + n4] = t4[n4];
          return e3;
        }
        ...
        var v2, m2, y2, g = (m2 = function(e3) {
          var t4 = (e3 = function e4(t5, n5, a2, r3, o2) {
            ...
            for (a2 || (a2 = b), o2 || (o2 = []); ++s2 < c2; ) {
              var l3 = t5[s2];
              a2(l3) ? i(o2, l3) : o2[o2.length] = l3;
            }
            return o2;
          }(e3)).length, n4 = t4;
          for (v2; n4--; ) if ("function" != typeof e3[n4]) throw new TypeError("Expected a function");
          return function() {
            for (var n5 = 0, a2 = t4 ? e3[n5].apply(this, arguments) : arguments[0]; ++n5 < t4; ) a2 = e3[n5].call(this, a2);
            return a2;
          };
        }, y2 = d(void 0 === y2 ? m2.length - 1 : y2, 0), function() {
          for (var e3 = arguments, t4 = -1, n4 = d(e3.length - y2, 0), a2 = Array(n4); ++t4 < n4; ) a2[t4] = e3[y2 + t4];
          t4 = -1;
          for (var r3 = Array(y2 + 1); ++t4 < y2; ) r3[t4] = e3[t4];
      ...
      var r2 = n2(141), o = function() {
        ...
        return t3.register = function(e4) {
          ...
          try {
            for (var t4 in this._callbacks) this._isPending[t4] || this._invokeCallback(t4);
          } finally {
          ...
          for (var t4 in this._callbacks) this._isPending[t4] = false, this._isHandled[t4] = false;
      ...
      e2.exports = function(e3, t3) {
        for (var n3 = arguments.length, r2 = new Array(n3 > 2 ? n3 - 2 : 0), o = 2; o < n3; o++) r2[o - 2] = arguments[o];
        if (!e3) {
          var i;
          if (void 0 === t3) i = new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
          else {
            var s = 0;
      ...
      function x2(e3, t3) {
        ...
        var n3, a2, r3 = function(e4, t4) {
          ...
          for (a3 = 0; a3 < o3.length; a3++) n4 = o3[a3], t4.indexOf(n4) >= 0 || (r4[n4] = e4[n4]);
          return r4;
        }(e3, t3);
        if (Object.getOwnPropertySymbols) {
          var o2 = Object.getOwnPropertySymbols(e3);
          for (a2 = 0; a2 < o2.length; a2++) n3 = o2[a2], t3.indexOf(n3) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, n3) && (r3[n3] = e3[n3]);
        }
        return r3;
      }
      function _(e3) {
      ...
      function L2(e3, t3) {
        ...
        if ("undefined" == typeof Symbol || null == e3[Symbol.iterator]) {
          if (Array.isArray(e3) || (n3 = R2(e3)) || t3) {
            n3 && (e3 = n3);
      ...
      function B2(e3) {
        return function(e4) {
          if (Array.isArray(e4)) return I2(e4);
        }(e3) || function(e4) {
      ...
      function ce2(e3) {
        e3 = e3.trim();
        try {
          if ("[" === (e3 = JSON.stringify(JSON.parse(e3)))[0]) return le2("array", JSON.parse(e3));
          if ("{" === e3[0]) return le2("object", JSON.parse(e3));
          if (e3.match(/\-?\d+\.\d+/) && e3.match(/\-?\d+\.\d+/)[0] === e3) return le2("float", parseFloat(e3));
          if (e3.match(/\-?\d+e-\d+/) && e3.match(/\-?\d+e-\d+/)[0] === e3) return le2("float", Number(e3));
          if (e3.match(/\-?\d+/) && e3.match(/\-?\d+/)[0] === e3) return le2("integer", parseInt(e3));
          if (e3.match(/\-?\d+e\+\d+/) && e3.match(/\-?\d+e\+\d+/)[0] === e3) return le2("integer", Number(e3));
        } catch (e4) {
        }
        switch (e3 = e3.toLowerCase()) {
          ...
          default:
            if (e3 = Date.parse(e3)) return le2("date", new Date(e3));
        }
      ...
      var _e = function(e3) {
        ...
        function n3(e4) {
          ...
          return i(this, n3), (a2 = t3.call(this, e4)).getEditIcon = function() {
            ...
            if (r3) return m2.a.createElement("div", null, m2.a.createElement("div", A2(t4, "detected-row"), r3, m2.a.createElement(je2, { className: "edit-check detected", style: o({ verticalAlign: "top", paddingLeft: "3px" }, A2(t4, "check-icon").style), onClick: function() {
              a2.submitEdit(true);
            } })));
        ...
        function n3() {
          ...
          return (e4 = t3.call.apply(t3, [this].concat(r3))).getObjectSize = function() {
            ...
            if (t4.displayObjectSize) return m2.a.createElement("span", Object.assign({ className: "object-size" }, A2(a3, "object-size")), n4, " item", 1 === n4 ? "" : "s");
            ...
            if (1 !== r4.length) return m2.a.createElement("span", { className: "click-to-remove", style: { display: t4 ? "inline-block" : "none" } }, m2.a.createElement(me2, Object.assign({ className: "click-to-remove-icon" }, A2(a3, "removeVarIcon"), { onClick: function() {
      ...
      var Ae2 = function(e3) {
        ...
        function n3(e4) {
          ...
          return i(this, n3), (a2 = t3.call(this, e4)).toggleCollapsed = function(e5) {
            var t4 = [];
            for (var n4 in a2.state.expanded) t4.push(a2.state.expanded[n4]);
        ...
        function n3(e4) {
          ...
          i(this, n3), (a2 = t3.call(this, e4)).toggleCollapsed = function() {
            ...
            return a2.props.sortKeys && "array" !== u3 && (p3 = p3.sort()), p3.forEach(function(r5) {
              if (n4 = new Pe2(r5, e5[r5]), "array_group" === i2 && s2 && (n4.name = parseInt(n4.name) + s2), e5.hasOwnProperty(r5)) if ("object" === n4.type) f3.push(m2.a.createElement(Fe2, Object.assign({ key: n4.name, depth: o2 + 1, name: n4.name, src: n4.value, namespace: l3.concat(n4.name), parent_type: u3 }, t4)));
              ...
              } else f3.push(m2.a.createElement(ke2, Object.assign({ key: n4.name + "_" + l3, variable: n4, singleIndent: 5, namespace: l3, type: a2.props.type }, t4)));
            }), f3;
          };
        ...
        return c(n3, [{ key: "getBraceStart", value: function(e4, t4) {
          ...
          if ("array_group" === a2.parent_type) return m2.a.createElement("span", null, m2.a.createElement("span", A2(o2, "brace"), "array" === e4 ? "[" : "{"), t4 ? this.getObjectMetaData(r3) : null);
          var s2 = t4 ? Se2 : we2;
      ...
      var Fe2 = Me2, De2 = function(e3) {
        ...
        return c(n3, [{ key: "componentDidMount", value: function() {
          ...
          for (var t4 in e4) q2.on(t4 + "-" + this.rjvId, e4[t4]);
          ...
          var e4 = this.getListeners();
          for (var t4 in e4) q2.removeListener(t4 + "-" + this.rjvId, e4[t4]);
        } }, { key: "render", value: function() {
      ...
      Be2.defaultProps = { src: {}, name: "root", theme: "rjv-default", collapsed: false, collapseStringsAfterLength: false, shouldCollapse: false, sortKeys: false, quotesOnKeys: true, groupArraysAfterLength: 100, indentWidth: 4, enableClipboard: true, displayObjectSize: true, displayDataTypes: true, onEdit: false, onDelete: false, onAdd: false, onSelect: false, iconStyle: "triangle", style: {}, validationMessage: "Validation Error", defaultValue: null, displayArrayKey: true }, Be2.validateState = function(e3) {
        ...
        return "object" !== _(e3.theme) || function(e4) {
          ...
          if ("object" === _(e4)) {
            for (var n3 = 0; n3 < t4.length; n3++) if (!(t4[n3] in e4)) return false;
            return true;
          }
          return false;
...
function ResourceDetails() {
  ...
  if (!selectedResource) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-slate-400 bg-slate-50 dark:bg-slate-900/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Select a resource to view details" }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-slate-200 dark:border-slate-800 font-semibold bg-white dark:bg-slate-900 flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedResource.Name || "Details" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-xs bg-slate-100 hover:bg-slate-200 px-2 py-1 rounded text-slate-600 dark:bg-slate-800 dark:text-slate-400", children: "JSON" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-auto p-4 bg-white dark:bg-slate-900", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 text-sm", children: Object.entries(selectedResource).map(([key, value]) => {
        if (typeof value === "object" || Array.isArray(value)) return null;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500 text-xs uppercase", children: key }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium truncate", title: String(value), children: String(value) })
        ] }, key);
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-bold uppercase text-slate-500 mb-2", children: "Raw Data" }),
...
const awsService = {
  ...
  listResources: async (type, config) => {
    switch (type) {
      case "job":
  ...
  getSubResources: async (type, parentId, config) => {
    switch (type) {
      case "job_run":
      ...
      case "table":
        return ipc.invoke("aws:get-tables", config, parentId);
      case "workflow_run":
...
function JsonModal() {
  ...
  const handleSave = () => {
    ...
    a.href = url;
    a.download = `${selectedResource.Name || "resource"}.json`;
    a.click();
    URL.revokeObjectURL(url);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-slate-900 w-3/4 h-3/4 rounded-lg shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-4 border-b border-slate-200 dark:border-slate-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-lg", children: "JSON Inspector" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setJsonModalOpen(false), className: "p-1 hover:bg-slate-100 dark:hover:bg-slate-800 rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-auto p-4 bg-slate-50 dark:bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ReactJson,
      {
        src: selectedResource,
        theme: "monokai",
...
function ProfileSwitcher() {
  ...
  const [tempProfile, setTempProfile] = reactExports.useState(config.profile);
  const [tempRegion, setTempRegion] = reactExports.useState(config.region);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-slate-900 w-96 rounded-lg shadow-xl p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: "AWS Configuration" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setProfileSwitcherOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5 text-slate-500" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1", children: "Profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1", children: "Region" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
...
function useKeyboardShortcuts() {
  const {
    ...
    // Need to make sure this exists in store
    setJsonModalOpen,
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MainLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 h-full flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 text-sm text-slate-500 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          breadcrumbStack.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: breadcrumbStack[breadcrumbStack.length - 1].id }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-slate-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: "Ctrl+P to switch profile" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "j to view JSON" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        MasterDetailView,
        {
          top: /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceDetails, {}),
          bottom: /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceTable, {})
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JsonModal, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileSwitcher, {})
  ] });
}
